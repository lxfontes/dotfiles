...
table.insert(plugins, require("v.plugins.autopairs"))
table.insert(plugins, require("v.plugins.barbecue"))
table.insert(plugins, require("v.plugins.catppuccin"))
table.insert(plugins, require("v.plugins.cmp"))
table.insert(plugins, require("v.plugins.colorizer"))
...
table.insert(plugins, require("v.plugins.hlargs"))
table.insert(plugins, require("v.plugins.indent"))
table.insert(plugins, require("v.plugins.markdown"))
table.insert(plugins, require("v.plugins.navigator"))
